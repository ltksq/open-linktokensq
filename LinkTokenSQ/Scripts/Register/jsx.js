...
$(document).ready(function () {
    ...
    $("#showTooltips").click(function () {
        ...
        var context = {
            ...
            , "pwd2": '', "wkcaddress": $("#wkcaddress").val()
            , "nickname": $("#txtnikename").val()
            , "puid": $("#txtpuid").val()
        };
        $.ajaxPost(AP_ROOT + "Register/URegister", context, function (response) {
    ...
    $("#btntelcode").click(function () {
        ...
        var context = { "tel": txttel, "area": $("#selarea").val(), "scode": txtscode, flag:0 };
